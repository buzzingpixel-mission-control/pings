...
import { SignalIcon, ChevronDownIcon } from '@heroicons/react/20/solid';
import { PingsWithViewOptions } from './Pings';
import PingListItem from './PingListItem';
import { useArchiveSelectedPingsMutation } from './PingData';
...
const PingList = (
    ...
    const archiveSelectedPingsMutation = useArchiveSelectedPingsMutation(
