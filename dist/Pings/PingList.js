...
var PingList = function (_a) {
    ...
    var archiveSelectedPingsMutation = (0, PingData_1.useArchiveSelectedPingsMutation)(items.filter(function (i) { return selectedItems.indexOf(i.id) > -1; }), isArchive);
    if (items.length < 1) {
        return (react_1.default.createElement(buzzingpixel_mission_control_frontend_core_1.NoResultsAddItem, { icon: react_1.default.createElement(solid_1.SignalIcon, null), headline: "No Pings match your filters" }));
    }
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement("div", { className: "bg-white rounded-md shadow-sm px-4" },
            react_1.default.createElement("ul", { className: "divide-y divide-gray-100" }, items.map(function (item) { return (react_1.default.createElement(PingListItem_1.default, { key: item.id, isArchive: isArchive, item: item, selectedItemsManager: selectedItemsManager })); })))));
};
exports.default = PingList;
